                    ...
                    children: [
                     ...
                     if (state is MapLoadingState)
                      Positioned.fill(child:   Container(
                        child: Center(child: CircularProgressIndicator(color: ColorsConst.mainColor,),),
                      ), )
                    ],
                  );
                },
            ...
            Positioned(
                ...
                child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        boxShadow: [BoxShadow(color: ColorsConst.mainColor.withOpacity(0.1),blurRadius: 2,spreadRadius: 1)]
                    ),
                    child:TextFormField(
                      controller:
                      _searchController,
