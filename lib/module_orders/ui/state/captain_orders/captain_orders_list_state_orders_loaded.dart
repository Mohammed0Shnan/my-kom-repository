...
import 'package:my_kom/module_orders/ui/widgets/order_widget/order_card.dart';
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                   'nearbyOrders', //S.of(context).nearbyOrders,
                    style: TextStyle(
                      fontSize: 12,
                      color: currentPage == 1
                          ? Theme.of(context).primaryColor
      ...
      uiList.add(Container(
        ...
        child: GestureDetector(
          ...
          child: OrderCard(
            ...
            subTitle: 'order number',// S.of(context).order + '#${element.id}',
            time:
            timeago.format(element.creationTime, locale: Localizations.localeOf(context).languageCode), active: true,
          ),
        ),
      ));
    });
    ...
    availableOrders.forEach((element) {
      uiList.add(Container(
        ...
        child: GestureDetector(
          ...
          child: OrderCard(
            title:'order id',// S.of(context).order + ' #${element.id}',
            subTitle: ' ',
            time: timeago.format(element.creationTime,
                locale: Localizations.localeOf(context).languageCode), active: true,
          ),
        ),
      ));
    });
