                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                            image: AssetImage('assets/icons/order_type_icon.png',),
                                            fit: BoxFit.contain
                                        ),
                                        border: Border.all(
                                            width: 2,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Switch(value: vipOrder, onChanged: (val){
                                      setState(() {
                                        vipOrder = val;
                                      if(vipOrder){
                                        vipOrderValue = 10.0;
                        ...
                        children: [
                          ...
                          BlocBuilder<ShopCartBloc, CartState>(
                              ...
                              builder: (context, state) {
                                ...
                                double total = vipOrderValue+ state.cart.subTotal;
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                shape: BoxShape.circle,
                              image: DecorationImage(
                                image: AssetImage('assets/icons/payment_methods_icon.png')
                              ),
                              border: Border.all(
                                width: 2,
                                color: Colors.blue
                         ...
                         setState(() {
                            ...
                            child: Material(
                              ...
                              child: Container(
                                ...
                                clipBehavior: Clip.antiAlias,
                                decoration: BoxDecoration(
                                    color:paymentGroupValue == PaymentMethodConst.CASH_MONEY? Colors.blue.shade200: Colors.white,
                                   border: Border.all(
                                     color: Colors.black12
                                   )
                                ),
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                          borderRadius: BorderRadius.circular(10),
                                        image:      paymentGroupValue == PaymentMethodConst.CREDIT_CARD? DecorationImage(
                                          image: AssetImage('assets/icons/money_icon.png',
                          ...
                          GestureDetector(
                            ...
                            child: Material(
                              ...
                              child: Container(
                                ...
                                clipBehavior: Clip.antiAlias,
                                decoration: BoxDecoration(
                                    color: paymentGroupValue == PaymentMethodConst.CREDIT_CARD? Colors.blue.shade200: Colors.white,
                                    border: Border.all(
                                        color: Colors.black12
                                    )
                                ),
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                          borderRadius: BorderRadius.circular(10),
                                          image:      paymentGroupValue == PaymentMethodConst.CASH_MONEY? DecorationImage(
