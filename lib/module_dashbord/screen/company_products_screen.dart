...
import 'package:my_kom/module_dashbord/bloc/store_products_company_detail_bloc.dart';

class StoreCompanyProductScreen extends StatefulWidget {
  final String storeID;
  final String companyId;
  const StoreCompanyProductScreen({ required this.companyId , required this.storeID, Key? key}) : super(key: key);
...
class _StoreCompanyProductScreenState extends State<StoreCompanyProductScreen> {
  ...
  @override
  void initState() {
    _bloc.getDetailProductsCompanyStore(widget.storeID, widget.companyId);
    super.initState();
  }
  @override
